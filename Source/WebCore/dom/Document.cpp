...
void Document::implicitClose()
{
    ...
    m_eventSender.dispatchPendingEventsWithType(eventNames().beforeloadEvent);
    m_eventSender.dispatchPendingEventsWithType(eventNames().loadEvent);
    m_eventSender.dispatchPendingEventsWithType(eventNames().errorEvent);
